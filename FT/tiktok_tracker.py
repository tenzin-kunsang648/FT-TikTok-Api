...
def extract_data(raw):
    ...
    return {
        ...
        'creator_follower_count': safe_int(stats.get('followerCount', author_stats.get('followerCount'))),
        'creator_following_count': safe_int(stats.get('followingCount', author_stats.get('followingCount'))),
        'creator_total_likes': safe_int(stats.get('heartCount', author_stats.get('heartCount'))),
        'creator_total_videos': safe_int(stats.get('videoCount', author_stats.get('videoCount'))),
